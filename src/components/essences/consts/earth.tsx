export const earthAbilities = [
  {
    ...
    name: "Stonecunning",
    description: "Gain proficiency in History. If already proficient, you gain expertise.",
    tier: "initiate",
    isActive: false,
    isPassive: true,
    isSpell: false,
  ...
  },
  {
    ...
    name: "Terramancer",
    description: "Gain expertise in Athletics when performing tasks involving lifting, pushing, or pulling heavy objects made of stone or earth.",
    tier: "adept",
    isActive: false,
    isPassive: true,
    isSpell: false,
  ...
  },
  {
    ...
    description: "You have expertise on Stealth checks to hide in rocky terrain or against stone surfaces.",
    tier: "adept",
    isActive: false,
    isPassive: true,
    isSpell: false,
  ...
  },
  {
    ...
    name: "Stone Fist III",
    description: "Your unarmed strikes deal 1d10 bludgeoning damage and count as magical for overcoming resistance and immunity.",
    tier: "master",
    isActive: false,
    isPassive: true,
    isSpell: false,
...
export const earthSpells = [
  ...
  },
  {
    ...
    name: "Tremor",
    description: "https://5e.tools/spells.html#tremor_grimhollowpg24",
    tier: "1st",
    isActive: false,
    isPassive: false,
    isSpell: true,
  ...
  },
  {
    ...
    name: "Earth Worm",
    description: "https://5e.tools/spells.html#earth%20worm_grimhollowpg24",
    tier: "6th",
    isActive: false,
    isPassive: false,
    isSpell: true,
